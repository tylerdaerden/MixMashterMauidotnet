...
namespace MixMashter
{
    public partial class MainPage : ContentPage
    {
        ...
        {
            User JohnDoe = new User(id: 1, "John", "Doe", "Johndoe", "johndoe@gmail.com", new DateTime(2000, 4, 15), "Test1234");
        ...
        private void buttonCreateAdmin_Clicked(object sender, EventArgs e)
        {
            ...
            Admin Boss = new Admin(1 ,"Le" , "Boss" , "Leboss" , "leboss@gmail.com" , new DateTime(1987,11,25) , "Test1234" , true);
        ...
        {
            Masher MasherPotato = new Masher(1 , "Masher" , "Potato" , "Mashedpotato", "MashedPotato@gmail.com" , new DateTime(1970,4,30) , "Test1234" , true);
